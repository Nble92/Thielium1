import{a as N,b as k,x as a,r as L,k as v,Q as p,j as O,R as Y,O as V,l as z,A as E,W}from"./index-iTnIfvae.js";import{n as l,c as _,o as S,r as b}from"./if-defined-C3qlV4Mx.js";import{T as A,D as F}from"./index-CPa_nEfk.js";import"./index-B_IqGAoH.js";import"./index-C9N9umkf.js";import"./index-DMCyx_0d.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;

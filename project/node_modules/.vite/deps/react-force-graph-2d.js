...
import {
  ...
  sum,
  zoom_default
} from "./chunk-GVVPKDVH.js";
import {
  require_prop_types
} from "./chunk-F5EN5CZ3.js";
import {
  require_react
...
function _unsupportedIterableToArray2(r, a2) {
  if (r) {
    ...
    return "Object" === t3 && r.constructor && (t3 = r.constructor.name), "Map" === t3 || "Set" === t3 ? Array.from(r) : "Arguments" === t3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t3) ? _arrayLikeToArray2(r, a2) : void 0;
  }
}
function index(kapsuleComponent) {
  ...
  return (0, import_react.forwardRef)(function(props, ref) {
    ...
    Object.keys(omit(props, [].concat(_toConsumableArray2(methodNames), _toConsumableArray2(initPropNames)))).filter(function(p) {
...
function data_default(value, key) {
  ...
  for (var m2 = groups.length, update5 = new Array(m2), enter = new Array(m2), exit = new Array(m2), j = 0; j < m2; ++j) {
    var parent2 = parents[j], group = groups[j], groupLength = group.length, data = arraylike(value.call(parent2, parent2 && parent2.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update5[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
...
function parseTypenames(typenames) {
  return typenames.trim().split(/^|\s+/).map(function(t3) {
    ...
    if (i >= 0) name = t3.slice(i + 1), t3 = t3.slice(0, i);
    return { type: t3, name };
  });
}
...
function on_default(typename, value, options) {
  var typenames = parseTypenames(typename + ""), i, n = typenames.length, t3;
  if (arguments.length < 2) {
...
function dispatch() {
  for (var i = 0, n = arguments.length, _ = {}, t3; i < n; ++i) {
    if (!(t3 = arguments[i] + "") || t3 in _ || /[\s.]/.test(t3)) throw new Error("illegal type: " + t3);
    _[t3] = [];
  }
...
Dispatch.prototype = dispatch.prototype = {
  ...
  on: function(typename, callback) {
    var _ = this._, T = parseTypenames2(typename + "", _), t3, i = -1, n = T.length;
    if (arguments.length < 2) {
      while (++i < n) if ((t3 = (typename = T[i]).type) && (t3 = get(_[t3], typename.name))) return t3;
      return;
    }
    if (callback != null && typeof callback !== "function") throw new Error("invalid callback: " + callback);
    while (++i < n) {
      if (t3 = (typename = T[i]).type) _[t3] = set(_[t3], typename.name, callback);
      else if (callback == null) for (t3 in _) _[t3] = set(_[t3], typename.name, null);
    }
    return this;
  },
  copy: function() {
    var copy = {}, _ = this._;
    for (var t3 in _) copy[t3] = _[t3].slice();
    return new Dispatch(copy);
  },
  call: function(type, that) {
    if ((n = arguments.length - 2) > 0) for (var args = new Array(n), i = 0, n, t3; i < n; ++i) args[i] = arguments[i + 2];
    if (!this._.hasOwnProperty(type)) throw new Error("unknown type: " + type);
    for (t3 = this._[type], i = 0, n = t3.length; i < n; ++i) t3[i].value.apply(that, args);
  },
  apply: function(type, that, args) {
    if (!this._.hasOwnProperty(type)) throw new Error("unknown type: " + type);
    for (var t3 = this._[type], i = 0, n = t3.length; i < n; ++i) t3[i].value.apply(that, args);
  }
};
...
function timerFlush() {
  ...
  var t3 = taskHead, e;
  while (t3) {
    if ((e = clockNow - t3._time) >= 0) t3._call.call(void 0, e);
    t3 = t3._next;
  }
  --frame;
}
...
function styleTween(name, value, priority) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t3 = (i0 = i) && styleInterpolate(name, i, priority);
    return t3;
  }
  tween._value = value;
  return tween;
...
var polyInOut = function custom3(e) {
  ...
  function polyInOut2(t3) {
    return ((t3 *= 2) <= 1 ? Math.pow(t3, e) : 2 - Math.pow(2 - t3, e)) / 2;
  }
...
var backInOut = function custom6(s) {
  ...
  function backInOut2(t3) {
    return ((t3 *= 2) < 1 ? t3 * t3 * ((s + 1) * t3 - s) : (t3 -= 2) * t3 * ((s + 1) * t3 + s) + 2) / 2;
  }
...
var elasticIn = function custom7(a2, p) {
  ...
  function elasticIn2(t3) {
    return a2 * tpmt(- --t3) * Math.sin((s - t3) / p);
  }
...
var elasticOut = function custom8(a2, p) {
  ...
  function elasticOut2(t3) {
    return 1 - a2 * tpmt(t3 = +t3) * Math.sin((t3 + s) / p);
  }
...
var elasticInOut = function custom9(a2, p) {
  ...
  function elasticInOut2(t3) {
    return ((t3 = t3 * 2 - 1) < 0 ? a2 * tpmt(-t3) * Math.sin((s - t3) / p) : 2 - a2 * tpmt(t3) * Math.sin((s + t3) / p)) / 2;
  }
...
function zoom_default2() {
  ...
  function schedule(transition2, transform3, point, event) {
    transition2.on("start.zoom", function() {
      ...
      var that = this, args = arguments, g = gesture(that, args).event(event), e = extent.apply(that, args), p = point == null ? centroid(e) : typeof point === "function" ? point.apply(that, args) : point, w = Math.max(e[1][0] - e[0][0], e[1][1] - e[0][1]), a2 = that.__zoom, b = typeof transform3 === "function" ? transform3.apply(that, args) : transform3, i = interpolate(a2.invert(p).concat(w / a2.k), b.invert(p).concat(w / b.k));
      return function(t3) {
        if (t3 === 1) t3 = b;
        else {
          var l = i(t3), k = w / l[2];
  ...
  function touchmoved(event, ...args) {
    ...
    for (i = 0; i < n; ++i) {
      t3 = touches[i], p = pointer_default(t3, this);
      if (g.touch0 && g.touch0[2] === t3.identifier) g.touch0[0] = p;
      else if (g.touch1 && g.touch1[2] === t3.identifier) g.touch1[0] = p;
    }
    t3 = g.that.__zoom;
    if (g.touch1) {
  ...
  function touchended(event, ...args) {
    ...
    for (i = 0; i < n; ++i) {
      t3 = touches[i];
      if (g.touch0 && g.touch0[2] === t3.identifier) delete g.touch0;
      else if (g.touch1 && g.touch1[2] === t3.identifier) delete g.touch1;
    }
  ...
  zoom2.wheelDelta = function(_) {
    return arguments.length ? (wheelDelta = typeof _ === "function" ? _ : constant_default3(+_), zoom2) : wheelDelta;
  };
  zoom2.filter = function(_) {
    return arguments.length ? (filter3 = typeof _ === "function" ? _ : constant_default3(!!_), zoom2) : filter3;
  };
  zoom2.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default3(!!_), zoom2) : touchable;
  };
  zoom2.extent = function(_) {
    return arguments.length ? (extent = typeof _ === "function" ? _ : constant_default3([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom2) : extent;
  };
...
function _unsupportedIterableToArray3(r, a2) {
  if (r) {
    ...
    var t3 = {}.toString.call(r).slice(8, -1);
    return "Object" === t3 && r.constructor && (t3 = r.constructor.name), "Map" === t3 || "Set" === t3 ? Array.from(r) : "Arguments" === t3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t3) ? _arrayLikeToArray3(r, a2) : void 0;
  }
}
...
function _assertClassBrand(e, t3, n) {
  if ("function" == typeof e ? e === t3 : e.has(t3)) return arguments.length < 3 ? t3 : n;
  throw new TypeError("Private element is not present on this object");
}
function _checkPrivateRedeclaration(e, t3) {
  if (t3.has(e)) throw new TypeError("Cannot initialize the same private elements twice on an object");
}
...
function _classPrivateFieldInitSpec(e, t3, a2) {
  _checkPrivateRedeclaration(e, t3), t3.set(e, a2);
}
...
function _unsupportedIterableToArray4(r, a2) {
  if (r) {
    ...
    var t3 = {}.toString.call(r).slice(8, -1);
    return "Object" === t3 && r.constructor && (t3 = r.constructor.name), "Map" === t3 || "Set" === t3 ? Array.from(r) : "Arguments" === t3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t3) ? _arrayLikeToArray4(r, a2) : void 0;
  }
}
var ENTROPY = 123;
...
function _unsupportedIterableToArray5(r, a2) {
  if (r) {
    ...
    var t3 = {}.toString.call(r).slice(8, -1);
    return "Object" === t3 && r.constructor && (t3 = r.constructor.name), "Map" === t3 || "Set" === t3 ? Array.from(r) : "Arguments" === t3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t3) ? _arrayLikeToArray5(r, a2) : void 0;
  }
}
...
var index4 = index2({
  ...
  init: function init2(domNode, state) {
    ...
    Object.entries(style).forEach(function(_ref2) {
      var _ref3 = _slicedToArray4(_ref2, 2), k = _ref3[0], v = _ref3[1];
...
function add3(tree, x2, d) {
  ...
  while (node.length) {
    ...
    if (parent2 = node, !(node = node[i = +right])) return parent2[i] = leaf, tree;
  }
  xp = +tree._x.call(null, node.data);
  if (x2 === xp) return leaf.next = node, parent2 ? parent2[i] = leaf : tree._root = leaf, tree;
  do {
...
function remove_default4(d) {
  ...
  if (node.length) while (true) {
    ...
    if (!(parent2 = node, node = node[i = +right])) return this;
    if (!node.length) break;
    if (parent2[i + 1 & 1]) retainer = parent2, j = i;
  }
...
function add4(tree, x2, y2, d) {
  ...
  while (node.length) {
    ...
    if (parent2 = node, !(node = node[i = bottom << 1 | right])) return parent2[i] = leaf, tree;
  }
  xp = +tree._x.call(null, node.data);
  yp = +tree._y.call(null, node.data);
  if (x2 === xp && y2 === yp) return leaf.next = node, parent2 ? parent2[i] = leaf : tree._root = leaf, tree;
  do {
...
function remove_default5(d) {
  ...
  if (node.length) while (true) {
    ...
    if (!(parent2 = node, node = node[i = bottom << 1 | right])) return this;
    if (!node.length) break;
...
function add5(tree, x2, y2, z2, d) {
  ...
  while (node.length) {
    ...
    if (parent2 = node, !(node = node[i = deep << 2 | bottom << 1 | right])) return parent2[i] = leaf, tree;
  }
  xp = +tree._x.call(null, node.data);
  yp = +tree._y.call(null, node.data);
  zp = +tree._z.call(null, node.data);
  if (x2 === xp && y2 === yp && z2 === zp) return leaf.next = node, parent2 ? parent2[i] = leaf : tree._root = leaf, tree;
  do {
...
function cover_default3(x2, y2, z2) {
  ...
  if (isNaN(x0)) {
    ...
    var t3 = x1 - x0 || 1, node = this._root, parent2, i;
    while (x0 > x2 || x2 >= x1 || y0 > y2 || y2 >= y1 || z0 > z2 || z2 >= z1) {
      i = (z2 < z0) << 2 | (y2 < y0) << 1 | x2 < x0;
      parent2 = new Array(8), parent2[i] = node, node = parent2, t3 *= 2;
      switch (i) {
        case 0:
...
function remove_default6(d) {
  ...
  if (node.length) while (true) {
    ...
    if (!(parent2 = node, node = node[i = deep << 2 | bottom << 1 | right])) return this;
    if (!node.length) break;
    if (parent2[i + 1 & 7] || parent2[i + 2 & 7] || parent2[i + 3 & 7] || parent2[i + 4 & 7] || parent2[i + 5 & 7] || parent2[i + 6 & 7] || parent2[i + 7 & 7]) retainer = parent2, j = i;
  }
  while (node.data !== d) if (!(previous = node, node = node.next)) return this;
  if (next = node.next) delete node.next;
  if (previous) return next ? previous.next = next : delete previous.next, this;
...
function link_default(links) {
  ...
  force.distance = function(_) {
    return arguments.length ? (distance2 = typeof _ === "function" ? _ : constant_default5(+_), initializeDistance(), force) : distance2;
  };
  return force;
}
  ...
  function apply2(treeNode, x1, arg1, arg2, arg3) {
    ...
    if (w * w / theta2 < l) {
      if (l < distanceMax2) {
        ...
        if (nDim > 1 && y2 === 0) y2 = jiggle_default(random2), l += y2 * y2;
        if (nDim > 2 && z2 === 0) z2 = jiggle_default(random2), l += z2 * z2;
...
var utils = {
  ...
  compute: function(t3, points, _3d) {
    ...
    if (order < 4) {
      let mt2 = mt * mt, t22 = t3 * t3, a2, b, c4, d = 0;
      if (order === 2) {
        p = [p[0], p[1], p[2], ZERO];
        a2 = mt2;
        b = mt * t3 * 2;
  ...
  length: function(derivativeFn) {
    ...
    for (let i = 0, t3; i < len; i++) {
      ...
      sum3 += utils.Cvalues[i] * utils.arcfn(t3, derivativeFn);
    }
    return z2 * sum3;
  },
  ...
  abcratio: function(t3, n) {
    ...
    const bottom = pow(t3, n) + pow(1 - t3, n), top = bottom - 1;
  ...
  projectionratio: function(t3, n) {
    ...
    const top = pow(1 - t3, n), bottom = pow(t3, n) + top;
    return top / bottom;
  },
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      ...
      if (d2 !== 0) {
        ...
        return [(2 * b10 - c5) / (2 * b10 - 2 * c5)].filter(reduce2);
      }
      return [];
    }
    ...
    if (discriminant < 0) {
      ...
      x2 = t1 * cos((phi + tau2) / 3) - a2 / 3;
      x3 = t1 * cos((phi + 2 * tau2) / 3) - a2 / 3;
  ...
  pairiteration: function(c1, c22, curveIntersectionThreshold) {
    const c1b = c1.bbox(), c2b = c22.bbox(), r = 1e5, threshold = curveIntersectionThreshold || 0.5;
...
var Bezier = class _Bezier {
  constructor(coords) {
    ...
    this._linear = aligned.reduce((t3, p) => t3 + abs2(p.y), 0) < baselength / 50;
    this._lut = [];
    this._t1 = 0;
    this._t2 = 1;
    this.update();
  ...
  static cubicFromPoints(S, B, E2, t3, d1) {
    if (typeof t3 === "undefined") {
      t3 = 0.5;
    }
    const abc = _Bezier.getABC(3, S, B, E2, t3);
    ...
    return new _Bezier(S, nc1, nc2, E2);
  }
  static getUtils() {
    return utils;
  }
  ...
  static getABC(order = 2, S, B, E2, t3 = 0.5) {
    const u = utils.projectionratio(t3, order), um = 1 - u, C = {
      x: u * S.x + um * E2.x,
      y: u * S.y + um * E2.y
    }, s = utils.abcratio(t3, order), A = {
      x: B.x + (B.x - C.x) / s,
      y: B.y + (B.y - C.y) / s
    };
    return { A, B, C, S, E: E2 };
  ...
  getABC(t3, B) {
    ...
    return _Bezier.getABC(this.order, S, B, E2, t3);
  }
  getLUT(steps) {
    this.verify();
    steps = steps || 100;
  ...
  on(point, error) {
    ...
    for (let i = 0, c4, t3 = 0; i < lut.length; i++) {
      c4 = lut[i];
  ...
  offset(t3, d) {
    if (typeof d !== "undefined") {
      const c4 = this.get(t3), n = this.normal(t3);
      const ret = {
        c: c4,
        n,
        x: c4.x + n.x * d,
...
function _objectWithoutProperties(e, t3) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (r = 0; r < s.length; r++) o = s[r], t3.includes(o) || {}.propertyIsEnumerable.call(e, o) && (i[o] = e[o]);
  }
  return i;
}
...
function _unsupportedIterableToArray6(r, a2) {
  if (r) {
    ...
    var t3 = {}.toString.call(r).slice(8, -1);
    return "Object" === t3 && r.constructor && (t3 = r.constructor.name), "Map" === t3 || "Set" === t3 ? Array.from(r) : "Arguments" === t3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t3) ? _arrayLikeToArray6(r, a2) : void 0;
  }
}
var index6 = function() {
...
function ramp(range2) {
  var n = range2.length;
  return function(t3) {
    return range2[Math.max(0, Math.min(n - 1, Math.floor(t3 * n)))];
  };
}
...
function _construct(t3, e, r) {
  if (_isNativeReflectConstruct()) return Reflect.construct.apply(null, arguments);
  var o = [null];
  o.push.apply(o, e);
  var p = new (t3.bind.apply(t3, o))();
  return p;
}
function _defineProperty3(e, r, t3) {
...
function _objectSpread22(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t3 = null != arguments[r] ? arguments[r] : {};
    r % 2 ? ownKeys2(Object(t3), true).forEach(function(r2) {
      _defineProperty3(e, r2, t3[r2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t3)) : ownKeys2(Object(t3)).forEach(function(r2) {
      Object.defineProperty(e, r2, Object.getOwnPropertyDescriptor(t3, r2));
    });
  }
  return e;
...
function _unsupportedIterableToArray7(r, a2) {
  if (r) {
    ...
    var t3 = {}.toString.call(r).slice(8, -1);
    return "Object" === t3 && r.constructor && (t3 = r.constructor.name), "Map" === t3 || "Set" === t3 ? Array.from(r) : "Arguments" === t3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t3) ? _arrayLikeToArray7(r, a2) : void 0;
  }
}
...
var linkedProps = Object.assign.apply(Object, _toConsumableArray5(["nodeColor", "nodeAutoColorBy", "nodeCanvasObject", "nodeCanvasObjectMode", "linkColor", "linkAutoColorBy", "linkLineDash", "linkWidth", "linkCanvasObject", "linkCanvasObjectMode", "linkDirectionalArrowLength", "linkDirectionalArrowColor", "linkDirectionalArrowRelPos", "linkDirectionalParticles", "linkDirectionalParticleSpeed", "linkDirectionalParticleWidth", "linkDirectionalParticleColor", "dagMode", "dagLevelDistance", "dagNodeFilter", "onDagError", "d3AlphaMin", "d3AlphaDecay", "d3VelocityDecay", "warmupTicks", "cooldownTicks", "cooldownTime", "onEngineTick", "onEngineStop"].map(function(p) {
  return _defineProperty3({}, p, bindFG.linkProp(p));
